...
import (
	"bmstu-dips-lab3/gateway-service/internal/gateway"
...
type GatewayHandlers struct {
	loyaltyCircuitBreaker     circuit_breaker.CircuitBreaker
	paymentCircuitBreaker     circuit_breaker.CircuitBreaker
	reservationCircuitBreaker circuit_breaker.CircuitBreaker
	jobScheduler              *job_scheduler.JobScheduler
}

func NewGatewayHandlers(loyaltyCircuitBreaker, paymentCircuitBreaker, reservationCircuitBreaker *circuit_breaker.CircuitBreaker, jobScheduler *job_scheduler.JobScheduler) gateway.Handlers {
	return &GatewayHandlers{
		loyaltyCircuitBreaker:     *loyaltyCircuitBreaker,
		paymentCircuitBreaker:     *paymentCircuitBreaker,
		reservationCircuitBreaker: *reservationCircuitBreaker,
...
func (g *GatewayHandlers) GetLoyalty() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		ires, err := g.loyaltyCircuitBreaker.Execute(func() (interface{}, error) {
...
func (g *GatewayHandlers) GetHotels() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		ires, err := g.reservationCircuitBreaker.Execute(func() (interface{}, error) {
			return http.DefaultClient.Do(req)
		})
		if err != nil {
	...
	return func(c *gin.Context) {
		...
		if err != nil {
			...
			job := job_scheduler.NewExecJob(func() (interface{}, error) {
				return http.DefaultClient.Do(decrementcounterreq)
			})
			g.jobScheduler.JobQueue <- job
			return
		}
...
func (g *GatewayHandlers) GetReservation() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		getreservationires, err := g.loyaltyCircuitBreaker.Execute(func() (interface{}, error) {
			return http.DefaultClient.Do(getreservationreq)
		})
		if err != nil {
			c.JSON(http.StatusServiceUnavailable, ErrorResponse{Message: "Reservation Service unavailable"})
			return
		...
		getreservationres, ok := getreservationires.(*http.Response)
		if !ok {
			c.AbortWithStatus(http.StatusInternalServerError)
			return
		}
		...
		getpaymentires, err := g.paymentCircuitBreaker.Execute(func() (interface{}, error) {
			return http.DefaultClient.Do(getpaymentreq)
		})
		if err != nil {
		...
		getpaymentres, ok := getpaymentires.(*http.Response)
		if !ok {
			c.AbortWithStatus(http.StatusInternalServerError)
			return
		}
...
func (g *GatewayHandlers) GetReservations() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		getreservationsires, err := g.loyaltyCircuitBreaker.Execute(func() (interface{}, error) {
			return http.DefaultClient.Do(getreservationsreq)
		})
		if err != nil {
			c.JSON(http.StatusServiceUnavailable, ErrorResponse{Message: "Reservation Service unavailable"})
			return
		...
		getreservationsres, ok := getreservationsires.(*http.Response)
		if !ok {
			c.AbortWithStatus(http.StatusInternalServerError)
			return
		}
...
func (g *GatewayHandlers) GetUserInfo() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		getloyaltyires, err := g.loyaltyCircuitBreaker.Execute(func() (interface{}, error) {
			return http.DefaultClient.Do(getloyaltyreq)
		})
		if err != nil {
		...
		getloyaltyres, ok := getloyaltyires.(*http.Response)
		if !ok {
			c.AbortWithStatus(http.StatusInternalServerError)
			return
		}
